  ...
  "inline-flex items-center rounded-full border px-2.5 py-0.5 text-xs font-semibold uppercase tracking-wide transition-colors",
  {
    variants: {
      variant: {
        ...
        accent: "border-transparent bg-amber-500/15 text-amber-300",
        outline: "border-white/20 text-slate-300",
        solid: "border-transparent bg-slate-100 text-navy-900",
        live: "border-transparent bg-red-500/15 text-red-300",
      },
    },
    defaultVariants: {
      variant: "default",
